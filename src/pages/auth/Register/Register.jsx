  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex  flex-col gap-4">
      ...
      <div>
        ...
        <TextInput id="email" type="text" placeholder="amera@route.com"  shadow {...register("email")} />
      ...
      <div>
        ...
        <TextInput id="name" type="text" placeholder="amera mohammed"  shadow {...register("name")}/>
